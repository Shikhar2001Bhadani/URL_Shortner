...
const UrlForm = () => {
  ...
  const handleSubmit = async () => {
    try{
      ...
      const newShortUrl = typeof response === 'string' ? response : response?.shortUrl || response?.url || ""
  ...
  // Reset shortUrl and copied when url or customSlug changes
            ...
            <div className="flex items-center">
              ...
              />
               <button
                ...
                } ${!shortUrl ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
                {copied ? 'Copied!' : 'Copy'}
              </button>
            </div>
